pub mod mod_deep_diffi {
    ...
    fn deep_diffi(a_json: serde_json::Value, b_json: serde_json::Value, _init_location: String, init_result: &Result) -> Result {
        ...
        for (json1_key, _json1_value) in json1.iter() {
            ...
            if !json2.contains_key(json1_key) {
                ...
                if _json1_value.is_object() {
                    ...
                    sub_result = deep_diffi(json!(json3), json!(json4), String::from(&_location) + "[", &sub_result);
                    ...
                    if json2[json1_key].is_array() {
                        for json1_array_val in _json1_value.as_array().unwrap().iter() {
                                ...
                                .contains(json1_array_val) && !json1_array_val.is_object()
                            {
                                ...
                                sub_result = deep_diffi(json!(&arr_1), json!(&json2[json1_key][j1i]), location1.to_string(), &sub_result);
                            }
                        }
